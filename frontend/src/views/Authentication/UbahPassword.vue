            ...
            <div class="row">
              <q-card square class="shadow-24" style="width:300px;height:485px;">
                <q-card-section class="bg-deep-purple-7">
                  <h4 class="text-h5 text-white q-my-md">Tobazone</h4>
                ...
                <q-card-actions class="q-px-lg">
                  <q-btn :loading="loading" @click="ubahpassword" unelevated
                         size="lg"
                         color="purple-4" class="full-width text-white" label="Ubah Password">
  ...
  export default {
    ...
    methods: {
      ubahpassword() {
        ...
        this.$q.loading.show()
        this.$http.post(`/ubahpassword/${this.$route.params.uuid}`, {
